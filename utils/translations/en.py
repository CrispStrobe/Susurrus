...
STRINGS = {
    ...
    "label.speaker_identity": "Preset voice is:",
    "opt.speaker_identity_default": "(shipped classification)",
    "opt.speaker_identity_real": "a real person",
    "opt.speaker_identity_synthetic": "synthetic",
    "opt.speaker_identity_unknown": "unknown",
    "tip.speaker_identity": (
        "Whether this backend's preset voice belongs to an identifiable "
        "person. If it does, the output is a deep fake under EU AI Act "
        "Art. 3(60) and an audible disclosure is prepended even without "
        "voice cloning. Leave on the shipped classification unless you know "
        "better than it does."
    ),
