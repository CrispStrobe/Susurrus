...
from .progress import process_with_progress
...
class DiarizationManager:
    ...
    def initialize_pipeline(self):
        ...
        try:
            ...
            # Move to the configured device (mps / cuda / cpu)
            ...
            if "401" in error_msg or "unauthorized" in error_msg.lower():
                ...
                logging.error("Required files not found in the model repository.")
    ...
    for model, test_file in models_to_check.items():
        try:
            ...
            if "403" in str(e) or "401" in str(e).lower() or "unauthorized" in str(e).lower():
                print("  ⚠️ This model is gated. Visit and request access:")
